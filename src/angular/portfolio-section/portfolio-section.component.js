...
angular.module('portfolioSection')
    .component('portfolioSection', {
      ...
      controller: function PortfolioSectionController($uibModal, $log, $document, $http) {
...
angular.module('portfolioSection').controller('ModalInstanceCtrl', function ($uibModalInstance, selectedItem) {
  var $ctrl = this;
